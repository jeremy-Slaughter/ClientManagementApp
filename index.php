...
//	Accounts Payable
	if ($enter_ap != '0' && $enter_ap != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$ap', 'Enter AP')";
		$result = $conn->query($sql);	}
	if ($approve_ap != '0' && $approve_ap != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$ap', 'Approve Ap')";
		$result = $conn->query($sql);	}
	if ($cut_checks != '0' && $cut_checks != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$ap', 'Cut Checks')";
		$result = $conn->query($sql);	}

//	Accounts Receivable
	if ($mail_statements != '0' && $mail_statements != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$ar', 'Mail Statements')";
		$result = $conn->query($sql);	}
	if ($reach_out_to_vendors != '0' && $reach_out_to_vendors != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$ar', 'Reach out to Vendors')";
		$result = $conn->query($sql);	}
	if ($deposit_checks != '0' && $deposit_checks != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$ar', 'Deposit Checks')";
		$result = $conn->query($sql);	}

//	Bank Reconciliation
	if ($access_to_online_banking != '0' && $access_to_online_banking != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$br', 'Access To Online Banking')";
		$result = $conn->query($sql);	}
	if ($one_bank_account != '0' && $one_bank_account != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$br', 'One Bank Account')";
		$result = $conn->query($sql);	}
	if ($multiple_bank_accounts != '0' && $multiple_bank_accounts != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$br', 'Multiple Bank Accounts')";
		$result = $conn->query($sql);	}
//	1099
	if ($mail_off != '0' && $mail_off != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$ten', 'Mail Off')";
		$result = $conn->query($sql);	}
	if ($ninety_nine_transmit != '0' && $ninety_nine_transmit != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$ten', '1099 Transmit')";
		$result = $conn->query($sql);	}
//	Check Stubs
	if ($enter_individual_stubs != '0' && $enter_individual_stubs != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$cs', 'Enter Individual Stubs')";
		$result = $conn->query($sql);	}
	if ($enter_single_stub != '0' && $enter_single_stub != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$cs', 'Enter Single Stub')";
		$result = $conn->query($sql);	}
//	Revenue Billing
	if ($severance_tax_filing != '0' && $severance_tax_filing != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$rev', 'Severance Tax Filing')";
		$result = $conn->query($sql);	}
	if ($distribute_revenue != '0' && $distribute_revenue != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$rev', 'Distribute Revenue')";
		$result = $conn->query($sql);	}
// 	Entering Payroll
	if ($entering_payroll != '0' && $entering_payroll != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$pay', 'Entering Payroll')";
		$result = $conn->query($sql);	}
	if ($paying_employees != '0' && $paying_employees != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$pay', 'Paying Employees')";
		$result = $conn->query($sql);	}
	if ($w2_mailing != '0' && $w2_mailing != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$pay', 'W2 Mailing')";
		$result = $conn->query($sql);	}
	if ($w2_transmit != '0' && $w2_transmit != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$pay', 'W2 Transmit')";
		$result = $conn->query($sql);	}
	if ($quarterly_filings != '0' && $quarterly_filings != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$pay', 'Quarterly Filings')";
		$result = $conn->query($sql);	}
//	Financials
	if ($monthly_financials != '0' && $monthly_financials != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$fin', 'Monthly Financials')";
		$result = $conn->query($sql);	}
	if ($quarterly_financials != '0' && $quarterly_financials != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$fin', 'Quarterly Financials')";
		$result = $conn->query($sql);	}
	if ($annually_financials != '0' && $annually_financials != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', '$fin', 'Annually Financials')";
		$result = $conn->query($sql);	}
...
//	Stand Alone
	...
	if ($land_system != '0' && $land_system != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', 'Land System', 'Land System')";
		$result = $conn->query($sql);	}
	if ($purchase_order != '0' && $purchase_order != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', 'Purchase Order', 'Purchase Order')";
		$result = $conn->query($sql);	}
	if ($service_ticket != '0' && $service_ticket != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', 'Service Ticket', 'Service Ticket')";
		$result = $conn->query($sql);	}
	if ($time_entry != '0' && $time_entry != null){
		$sql ="INSERT INTO testapp VALUES (NULL, '$company_name', 'Time Entry', 'Time Entry')";
		$result = $conn->query($sql);	}
